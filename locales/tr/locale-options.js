...
il8n.strings = {
	...
	Title: 'Tab Vault Seçenekleri',				// Options page tab title
	By: 'By',
	
	TitleHelp: 'Tab Vault Yardım',			// Help page tab title
	TitleHelp2: 'Yardım',
	TitleUpgrade: 'Tab Vault Güncelleyicisi',		// Upgrade page tab title
	TitleUpgrade2: 'Güncelleyici',
	
	Default: 'Varsayılan',						// Default button text
	ActionFailed: 'Hata!',				// Status message for errors
	...
	TextColor: 'Düğme yazı rengi',
	TextAlpha: 'Düğme yazı saydamlığı',
	...
	ImportPlaceholder: 'Oturum dosyasını (.win) bir metin düzenleyicide açın, sonrasında tüm içeriğini buraya kopyala/yapıştırın.',
	
	
	Reset: 'Sıfırlama',							// Reset category header
	ResetSettingsButton: 'Ayarları Sıfırla',
	ResetSettings: 'Ayarları ilk kurulum değerlerine çevirir',
	ResetTabsButton: 'Sekmeleri Temizle',
	ResetTabs: 'Tab Vault\'un kaydettiği tüm sekmeleri siler',
	ResetAllButton: 'Her Şeyi Sıfırla',
	ResetAll: 'Tab Vault\'un tamamını ilk kuruluma döndürür.',
	
	ExternalAccess: 'Düğmeler ve Kısayollar',
	EnableAccess: 'Kısayolların Tab Vault\'a erişebilmesi için bir parola ayarlayın',
	Password: 'Parola',
	NewPassword: 'Yeni Bir Parola Oluştur',
	...
	Upgrading: 'Ayarlarınız Güncelleniyor',	// Upgrade explanation header
	UpgradeMessage: 'Tab Vault 2 ayarlarınızı 1. sürümden biraz daha farklı bir şekilde saklar, bu yüzden ' +
			'olası uyumsuzlukları engellemek amacıyla, Tab Vault ayarlarınızı yeni formata göre' +
			'güncelleyecek. Tab Vault kaydettiğiniz sekmeleri bir oturum dosyası gibi çıkarttı.' +
			'(sekmelerinize bakın. Bunun yanında açılmalılar.) Eğer güncelleme başarısız olursa, ' +
			'bu oturumu sekmelerinizi kurtarmak için aktarabilirsiniz.',

	UpgradeButton: 'Şimdi Güncelle!',
	UpgradeDone: 'Tab Vault artık kullanıma hazır!',		// Upgrade success header
	UpgradeHelp: '2. Sürümdeki Yenilikleri Görün',
	UpgradePrefs: 'Tercihlerinizi değiştirin',
	UpgradeClose: 'Gezinmeye dön!',
	
	UpgradeStatus1: 'Varolan ayarlar alınıyor...',		// Upgrade status message
	UpgradeStatus2: 'Varolan sekmeler alınıyor...',
	UpgradeStatus3: 'Eklentinin verileri temizleniyor...',
	UpgradeStatus4: 'Ayarlar geri yükleniyor...',
	UpgradeStatus5: 'Sekmeler geri yükleniyor...',
	
	UpgradeFail1: 'N\'olamaz! Bir yanlışlık var. (ya da acayip yavaş bir bilgisayarınız var.)',
	UpgradeFail2: 'Ctrl+Shift+O\'ya basarak açtığnız hata günlüğünün "Starting upgrade" kısmından sonraki metni' + 
			'<a href="https://addons.opera.com/addons/extensions/details/tab-vault/">Tab Vault\'un eklenti sayfasında</a> "Reported Issued" kısmına' +
			'göndererek yardım edebilirsiniz.' +
