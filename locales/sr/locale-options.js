...
il8n.strings = {
	...
	VaultSettings: 'Поставке чувања',			
	DisplaySettings: 'Поставке приказа',	
	OtherSettings: 'Остале поставке',
	...
	AllowListDuplicates: 'Дозволи дупплирање страна на главном списку',
	AllowGroupDuplicates: 'Дозволи дуплирање страна у групама',
	RemoveListDuplicates: 'Уклони дуплит са главног списка када додам страну у групу',
	RemoveGroupDuplicates: 'Уклони дупликат из групе када додам страну на главни списак',
	...
	CloseOnOpen: 'Затвори искачући прозор након отварања стране',
	KeepGroupsOpen: 'Задржи групе проширене приликом поновног отварања искачућег прозора',
	OpenOneGroup: 'Дозволи да само једна група буде проширена',
	...
	LimitTrash: 'Ограничи величину корпе',
	MaxTrash: 'Максимално страна у корпи',
	...
	Language: 'Језик (промена захтева поновно покретање)',
	
	EnableClipboard: 'Да бисте омогућили корирање URL адреса страна, идите на ' +
				'<a href="http://www.macromedia.com/support/documentation/en/flashplayer/help/settings_manager04a.html">подешавања Flash плејера</a> ' +
				'и додајте ову URL адресу на списак поузданих локација.',
	...
	ExportAdrButton: 'Извези .adr',
	ExportAdr: 'Извезите сачуване стране као датотеку одабира',
	ImportButton: 'Увези сесију',
	Import: 'Увезите датотеку сесије или одабира (.win или .adr) међу своје сачуване стане',
	ImportWorking: 'Увоз...',
	ImportPlaceholder: 'Отворите датотеку сесије (.winor или .adr) у уређивачу текста, затим копирајте и налепите њен садржај овде пре него што кликнете Увези.',
	...
	CustomButton: 'Прикагођена икона (унесите назив иконе из пресвлаке)',
